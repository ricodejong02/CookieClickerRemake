...
namespace Kaziklikker
{
    public partial class Form1 : Form
    {
        ...
        UInt64 Money = 5;
        UInt64 CPS = 0;
        UInt64 ClickerPrice = 10;
        UInt64 FarmPrice = 50;
        UInt64 MinePrice = 100;
        UInt64 VillagePrice = 250;
        UInt64 CityPrice = 500;
        UInt64 CountryPrice = 1000;
        UInt64 PlanetPrice = 5000;
        UInt64 GalaxyPrice = 10000;
        UInt64 ClickingPrice = 1500;
        UInt64 ClickingSpeed = 1;
        UInt64 ClickerAmount = 0;
        UInt64 FarmAmount = 0;
        UInt64 MineAmount = 0;
        UInt64 VillageAmount = 0;
        UInt64 CityAmount = 0;
        UInt64 CountryAmount = 0;
        UInt64 PlanetAmount = 0;
        UInt64 GalaxyAmount = 0;
        UInt64 ClickingAmount = 0;
        UInt64 BankRente = 11;
        UInt64 ClickerSpeed = 1;
        UInt64 FarmSpeed = 3;
        UInt64 MineSpeed = 5;
        UInt64 VillageSpeed = 10;
        UInt64 CitySpeed = 20;
        UInt64 CountrySpeed = 35;
        ...
        UInt64 FarmBuffer = 0;
        UInt64 MineBuffer = 0;
        UInt64 VillageBuffer = 0;
        UInt64 CityBuffer = 0;
        UInt64 CountryBuffer = 0;
        UInt64 PlanetBuffer = 0;
        UInt64 GalaxyBuffer = 0;
        UInt64 UniverseBuffer = 0;
        UInt64 UniversePrice = 25000000;
        UInt64 UniverseAmount = 0;
        UInt64 UniverseSpeed = 100000;
        UInt64 GodPrice = 250000000;
        UInt64 GodAmount = 0;
        UInt64 TotalClicks = 0;
        #endregion
